...
class SentimentModel:
    ...
    def _train_model(self):
        ...
        val_sequences = self.tokenizer.texts_to_sequences(X_validation)
        X_validation = pad_sequences(val_sequences, maxlen=self.max_len)
    ...
    def predict_sentiment(self, text_twitter):
        ...
        sequence = self.tokenizer.texts_to_sequences([text_twitter])
